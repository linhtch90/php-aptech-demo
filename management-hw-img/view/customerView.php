...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
                                ...
                                <tbody>
                                    ...
                                    if ($customers != null) {
                                        foreach ($customers as $customer) {
                                            ...
                                            <td>
                                            <a href='../index.php?action=customerUpdateForm&id={$customer["Id"]}' >Update</a>
                                            </td>
                                            <td>
                                            <a href='../index.php?action=customerDelete&id={$customer["Id"]}' >Delete</a>
                                            </td>
                                            </tr>
                                            ");
                                        }
            ...
            <a class="btn bg-gradient-primary mt-4 w-25" href="../index.php?action=customerAddForm" type="button">Add New Customer</a>
